...
def load_data(data_path):
    ...
    dependence = pd.read_csv(data_path + '/dependence.tsv', sep='\t', dtype={0:np.int32, 1:np.int32})
    return [adj, latest_sessions, user_id_map, item_id_map, train, valid, test, dependence]
